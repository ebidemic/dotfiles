...
you should place your code here."
  ...
  ;;　クリップボードをemacsとmacで共有する
  (setq x-select-enable-clipboard t)
  ;; helm-bookmarkの設定
  (require 'helm-bookmark)
  ;; org-modeにおけるM-RETの挙動
  ...
  (add-hook 'yatex-mode-hook
            '(lambda ()
               (define-key YaTeX-mode-map "\C-c\C-s" 'rio-yatex-sectioning)))
  (defun rio-yatex-sectioning ()
    (interactive)
    (YaTeX-section-overview)
                                        ;  (setq w (selected-window))
    (delete-other-windows)
    (setq w (selected-window))
    (setq w1 (split-window w 60 t))
    (set-window-buffer (selected-window) "*Sectioning lines*")
    )
...
;;  (yas/initialize)
  ...
  (add-to-list 'load-path "~/.emacs.d/freefem-mode")
...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (howm org-mime fish-mode engine-mode web-beautify livid-mode skewer-mode simple-httpd json-mode json-snatcher json-reformat js2-refactor multiple-cursors js2-mode js-doc company-tern dash-functional tern coffee-mode elscreen yasnippet-snippets metaweblog xml-rpc org2blog helm-themes helm-swoop helm-projectile helm-mode-manager helm-flx helm-descbinds helm-css-scss helm-company helm-c-yasnippet helm-ag ace-jump-helm-line web-mode tagedit slim-mode scss-mode sass-mode pug-mode less-css-mode haml-mode emmet-mode company-web web-completion-data yatex unfill reveal-in-osx-finder pbcopy osx-trash osx-dictionary org-projectile org-category-capture org-present org-pomodoro alert log4e gntp org-download mwim mmm-mode markdown-toc markdown-mode launchctl htmlize gnuplot gh-md fuzzy company-statistics company auto-yasnippet yasnippet ac-ispell auto-complete ws-butler winum which-key wgrep volatile-highlights vi-tilde-fringe uuidgen use-package toc-org spaceline powerline smex restart-emacs request rainbow-delimiters popwin persp-mode pcre2el paradox spinner org-plus-contrib org-bullets open-junk-file neotree move-text macrostep lorem-ipsum linum-relative link-hint ivy-hydra info+ indent-guide hydra hungry-delete hl-todo highlight-parentheses highlight-numbers parent-mode highlight-indentation hide-comnt help-fns+ helm-make helm helm-core google-translate golden-ratio flx-ido flx fill-column-indicator fancy-battery eyebrowse expand-region exec-path-from-shell evil-visualstar evil-visual-mark-mode evil-unimpaired evil-tutor evil-surround evil-search-highlight-persist evil-numbers evil-nerd-commenter evil-mc evil-matchit evil-lisp-state smartparens evil-indent-plus evil-iedit-state iedit evil-exchange evil-escape evil-ediff evil-args evil-anzu anzu evil goto-chg undo-tree eval-sexp-fu highlight elisp-slime-nav dumb-jump popup f dash s diminish define-word counsel-projectile projectile pkg-info epl counsel swiper ivy column-enforce-mode clean-aindent-mode bind-map bind-key auto-highlight-symbol auto-compile packed async aggressive-indent adaptive-wrap ace-window ace-link avy))))
(custom-set-faces
